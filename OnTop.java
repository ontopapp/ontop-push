...
public class OnTop
{
     ...
     * @return self
     */
    public OnTopNotification setMessage(String message)
    {
     ...
     * @return self
     */
    public OnTopNotification setView(String view)
    {
        this.view = view;
        return this;
    }
     ...
     * @return self
     */
    public OnTopNotification setCategory(String category)
    {
     ...
     * @return self
     */
    public OnTopNotification setAction(String action)
    {
        this.action = action;
        return this;
    }
     ...
     * @return self
     */
    public OnTopNotification setCustom(String key, String value)
    {
        try {
     ...
     * @return self
     */
    public OnTopNotification setCustom(String key, boolean value)
    {
        try {
            this.custom.put(key, value);
        } catch (JSONException e) {
     ...
     * @return self
     */
    public OnTopNotification setCustom(String key, int value)
    {
        try {
            this.custom.put(key, value);
        } catch (JSONException e) {
     ...
     * @return self
     */
    public OnTopNotification setCustom(String key, long value)
    {
        try {
            this.custom.put(key, value);
        } catch (JSONException e) {
     ...
     * @return self
     */
    public OnTopNotification setCustom(String key, double value)
    {
        try {
            this.custom.put(key, value);
        } catch (JSONException e) {
     ...
     * @return self
     */
    public OnTopNotification setNotificationVibrate(boolean notificationVibrate)
    {
     ...
     * @return self
     */
    public OnTopNotification setNotificationSound(boolean notificationSound)
    {
     ...
     * You don't need this if you're using either {@link OnTopNotification#getCompiledUrl()}
     * or {@link OnTopNotification#send()}
     *
     ...
     * You dont need to use this if you're using {@link OnTopNotification#send()}
     *
     * @return Compiled URL
     */
     ...
     * If you need to make a GET call use {@link OnTopNotification#getCompiledUrl()}
     * If you want to build you're own POST call use {@link OnTopNotification#getBaseUrl()}
